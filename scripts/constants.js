...
export const BLOCKS = {
  ...
  MM2_AIRMAN: `${BLOCKS_PATH}/${MEGAMAN_PATH}/MM2_AirMan.png`,
  MM2_BUBBLEMAN: `${BLOCKS_PATH}/${MEGAMAN_PATH}/MM2_BubbleMan.png`,
  MM2_CRASHMAN: `${BLOCKS_PATH}/${MEGAMAN_PATH}/MM2_CrashMan.png`,
  MM2_FLASHMAN: `${BLOCKS_PATH}/${MEGAMAN_PATH}/MM2_FlashMan.png`,
  MM2_HEATMAN: `${BLOCKS_PATH}/${MEGAMAN_PATH}/MM2_HeatMan.png`,
  MM2_METALMAN: `${BLOCKS_PATH}/${MEGAMAN_PATH}/MM2_MetalMan.png`,
  MM2_QUICKMAN: `${BLOCKS_PATH}/${MEGAMAN_PATH}/MM2_QuickMan.png`,
  MM2_WOODMAN: `${BLOCKS_PATH}/${MEGAMAN_PATH}/MM2_WoodMan.png`,
  MM2_DRWILLY: `${BLOCKS_PATH}/${MEGAMAN_PATH}/MM2_DrWilly.png`,

  MM3_BREAKMAN: `${BLOCKS_PATH}/${MEGAMAN_PATH}/MM3_BreakMan.png`,
  MM3_GEMINIMAN: `${BLOCKS_PATH}/${MEGAMAN_PATH}/MM3_GeminiMan.png`,
  MM3_HARDMAN: `${BLOCKS_PATH}/${MEGAMAN_PATH}/MM3_HardMan.png`,
  MM3_MAGNETMAN: `${BLOCKS_PATH}/${MEGAMAN_PATH}/MM3_MagnetMan.png`,
  MM3_NEEDLEMAN: `${BLOCKS_PATH}/${MEGAMAN_PATH}/MM3_NeedleMan.png`,
  MM3_SHADOWMAN: `${BLOCKS_PATH}/${MEGAMAN_PATH}/MM3_ShadowMan.png`,
  MM3_SNAKEMAN: `${BLOCKS_PATH}/${MEGAMAN_PATH}/MM3_SnakeMan.png`,
  MM3_SPARKMAN: `${BLOCKS_PATH}/${MEGAMAN_PATH}/MM3_SparkMan.png`,
  MM3_TOPMAN: `${BLOCKS_PATH}/${MEGAMAN_PATH}/MM3_TopMan.png`,
