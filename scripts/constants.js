...
export const BLOCKS = {
  ...
  MTSLG_H: `${BLOCKS_PATH}/MtSlg_H.png`,
  ...
  MTSLG_T: `${BLOCKS_PATH}/MtSlg_T.png`,
  ...
  SMW_ICE: `${BLOCKS_PATH}/SMW_ice_block.png`,
  SMW_MESSAGE: `${BLOCKS_PATH}/SMW_message_block.png`,
  ...
  SMW_QUESTION_RED: `${BLOCKS_PATH}/SMW_question_block_red.png`,
  SMW_ROTATING_BLUE: `${BLOCKS_PATH}/SMW_rotating_block_blue.png`,
  SMW_ROTATING_GREEN: `${BLOCKS_PATH}/SMW_rotating_block_green.png`,
  SMW_ROTATING_RED: `${BLOCKS_PATH}/SMW_rotating_block_red.png`,
  ...
  SMW_USED: `${BLOCKS_PATH}/SMW_used_block.png`,
  ...
  MINE_BAMBOO_BLOCK: `${BLOCKS_PATH}/MINE_bamboo_block.png`,
  MINE_BAMBOO_BLOCK_TOP: `${BLOCKS_PATH}/MINE_bamboo_block_top.png`,
  MINE_BEEHIVE_END: `${BLOCKS_PATH}/MINE_beehive_end.png`,
  MINE_BEEHIVE_FRONT: `${BLOCKS_PATH}/MINE_beehive_front.png`,
  MINE_BEEHIVE_FRONT_HONEY: `${BLOCKS_PATH}/MINE_beehive_front_honey.png`,
  MINE_BEEHIVE_SIDE: `${BLOCKS_PATH}/MINE_beehive_side.png`,
  MINE_BEE_NEST_BOTTOM: `${BLOCKS_PATH}/MINE_bee_nest_bottom.png`,
  MINE_BEE_NEST_FRONT: `${BLOCKS_PATH}/MINE_bee_nest_front.png`,
  MINE_BEE_NEST_FRONT_HONEY: `${BLOCKS_PATH}/MINE_bee_nest_front_honey.png`,
  MINE_BEE_NEST_SIDE: `${BLOCKS_PATH}/MINE_bee_nest_side.png`,
  MINE_BEE_NEST_TOP: `${BLOCKS_PATH}/MINE_bee_nest_top.png`,
  MINE_BOW_TABLE_FRONT: `${BLOCKS_PATH}/MINE_bow_table_front.png`,
  MINE_BOW_TABLE_SIDE: `${BLOCKS_PATH}/MINE_bow_table_side.png`,
  MINE_BOW_TABLE_TOP: `${BLOCKS_PATH}/MINE_bow_table_top.png`,
  MINE_BRONZE_BLOCK: `${BLOCKS_PATH}/MINE_Bronze_block.png`,
  MINE_CRAFTING_TABLE_FRONT: `${BLOCKS_PATH}/MINE_crafting_table_front.png`,
  MINE_CRAFTING_TABLE_SIDE: `${BLOCKS_PATH}/MINE_crafting_table_side.png`,
  MINE_CRAFTING_TABLE_TOP: `${BLOCKS_PATH}/MINE_crafting_table_top.png`,
  MINE_FURNACE_FRONT_OFF: `${BLOCKS_PATH}/MINE_furnace_front_off.png`,
  MINE_FURNACE_FRONT_ON: `${BLOCKS_PATH}/MINE_furnace_front_on.png`,
  MINE_FURNACE_SIDE: `${BLOCKS_PATH}/MINE_furnace_side.png`,
  MINE_FURNACE_TOP: `${BLOCKS_PATH}/MINE_furnace_top.png`,
  MINE_GOLD_BLOCK: `${BLOCKS_PATH}/MINE_gold_block.png`,
  MINE_GOLD_ORE: `${BLOCKS_PATH}/MINE_gold_ore.png`,
  MINE_GRASS_BLOCK_BOTTOM: `${BLOCKS_PATH}/MINE_grass_block_bottom.png`,
  MINE_GRASS_BLOCK_SIDE: `${BLOCKS_PATH}/MINE_grass_block_side.png`,
  MINE_GRASS_BLOCK_TOP: `${BLOCKS_PATH}/MINE_grass_block_top.png`,
  MINE_IRON_ORE: `${BLOCKS_PATH}/MINE_iron_ore.png`,
  MINE_OAK_LOG: `${BLOCKS_PATH}/MINE_oak_log.png`,
  MINE_OAK_LOG_TOP: `${BLOCKS_PATH}/MINE_oak_log_top.png`,
  MINE_REDSTONE_ORE: `${BLOCKS_PATH}/MINE_redstone_ore.png`,
  MINE_TNT_BOTTOM: `${BLOCKS_PATH}/MINE_tnt_bottom.png`,
  MINE_TNT_SIDE: `${BLOCKS_PATH}/MINE_tnt_side.png`,
  MINE_TNT_TOP: `${BLOCKS_PATH}/MINE_tnt_top.png`,
};
